...
mesh-bus-ingress-http-connect governs:
...
mesh-bus-ingress-http-connect depends_on:
...
mesh-bus-ingress-http-connect invariants:
...
mesh-bus-ingress-http-connect extends:
